function x = gaussPPivotDisp( A, b )
% gaussPPivotDisp: linear solver using gaussian elim with partial pivoting
%   [ x ] = gaussPPivotDisp( A, b )
...
display(aug);   % display the starting augmented matrix
%==========================================================================
% Main Algorithm:
...
for k = 1:n-1
    ...
    if i ~= 1
        ...
        display(aug);   % display the result of the pivot
    end    
    %**********************************************************************
    ...
    display(aug);   % display after each pivot column elimination
end
% (n-1) cycles in k
