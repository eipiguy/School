function I = simp13( f,a,b,n,varargin )
% simp13: composite simpson 1/3 rule integrator [ (f+3)2n ]
%  I = simp13( f,a,b,n,varargin )
%       estimates the integral of f from a to b
%       using simposins 1/3 rule with n segments 
%       (picking 3 points from each with matching endpoints)
% input:
...
n = 2*n;            % double the number of segments for the algorithm
...
c = [2;4];      % constants for weighting the algorithm correctly
l = length(c);  % length of coefficients vector

%==========================================================================
% Main Algorithm:
%
% Total Flops: sum_{i=2}^{2n}[ 1 +f +2 ] +f +1 +2 = (2n-1)(f+3)
%   = (f+3)2n -(f+3)
