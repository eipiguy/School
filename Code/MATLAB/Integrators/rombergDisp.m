function [ q,ea,iter ] = rombergDisp( f,a,b,es,maxit,varargin )
% rombergDisp: trapezoidal Romberg integrator with Richardson [  ]
%  [ q,ea,iter ] = rombergDisp( f,a,b,es,maxit,varargin )
...
%       and displaying the results as you go
% requires:
